...
0.6.0 connects one **Casa** parent to the server's authenticated voice-agent
...
**Requires:** Home Assistant 2026.4+ and Casa v0.90.0, which exposes the
authenticated `GET /api/voice/agents` schema 1 catalog and coordinated voice
handoff.

Upgrade Casa to v0.90.0 before installing integration v0.6.0. Specialist
...
new v0.6.0 entry or reconcile its catalog. An existing v0.6.0 entry with retained children may
