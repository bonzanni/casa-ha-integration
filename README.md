...
## Compatibility and coordinated v0.5.0 upgrade

Upgrade Casa to v0.89.0 before installing integration v0.5.0. The releases are
...
v0.5.0 entry or reconcile its catalog. An existing v0.5.0 entry with retained children
...
1. Upgrade Casa to v0.89.0, which includes the authenticated agent catalog and
